...
<div id = "primary navbar">
    <ul>
        <li><?php // this code will help us say hi then the name of the person thats logged in
            echo "<p> Hello "
                . " " . ucwords($_SESSION['userDetails']['Firstname']) //added func to change each first letter to capital.
...
<div id = "Secondary Navbar">
    <ul>
        <li><a href="registeredhomepage.php">HOMEPAGE</a></li>
        <li><a href="#vieweditparcel">VIEW</a></li>
        <li><a href="createparcel.php">CREATE</a></li>
        <li><a href="registeredhomepage.php#tracking">TRACK</a></li>
    </ul>
</div>
<div id="container">
<div id = "tracking">
        ...
        <div id= "vieweditparcel">
            ...
            <table class="table">
                ...
                if($result){
                    ...
                    <td data-label style="color: red" = "Status">'.$parcelstatus.'</td>
                    <td data-label = "Operations">
                        <button><a href = "fullview.php?viewid='.$trackingno.'" class="status">VIEW</a></button>
                        <button><a href = "updateParcel.php?updateparcelid='.$trackingno.'" class="status">UPDATE</a></button>
                     </td>
                </tr>';
                    }
                }
